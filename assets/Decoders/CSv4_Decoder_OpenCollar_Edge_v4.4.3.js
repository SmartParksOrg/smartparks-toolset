...
function decodeUbloxLocationMessage(bytes) {
    ...
    var latitude = value / 10000000; // gps latitude,units: Ã‚Â°
    value = bytes[14] << 24 | bytes[13] << 16 | bytes[12] << 8 | bytes[11];
    var longitude = value / 10000000; // gps longitude,units: Ã‚Â°
...
function decodeUbloxLocationMessageShort(bytes){
    var fix_time = bytes[5] << 24 | bytes[4] << 16| bytes[3] << 8 | bytes[2];
